...
import {isDate, mergeStyles, toShortDate} from '@lib/utils/helpers';
...
const DatePicker = ({defaultValue, theme, inputProps = {}, ...rest}) => {
    ...
    <Box style={styles.container}>
      <TouchableOpacity
        ...
        <AnimatedTextInput
          name={Name}
          ref={ref}
          value={value && isDate(value) ? toShortDate(value) : ''}
          editable={false}
          disabled={disabled}
          {...inputProps}
          style={[
