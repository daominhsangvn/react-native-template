...
import {isDate, mergeStyles, toFullDate} from '@lib/utils/helpers';
...
const DateTimePicker = ({defaultValue, theme, inputProps = {}, ...rest}) => {
    ...
    <Box style={styles.container}>
      <TouchableOpacity
        ...
        <AnimatedTextInput
          name={Name}
          ref={ref}
          value={value && isDate(value) ? toFullDate(value) : ''}
          editable={false}
          disabled={disabled}
          {...inputProps}
          style={[
